...
import { Eye, EyeOff, Loader2, Mail, MessagesSquare, User, Lock } from "lucide-react";
...
const SignupPage = () => {
  ...
  const validateForm = () => {
    ...
    if(!formData.email.trim()) return toast.error('Full name is requires')
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10 focus:outline-none focus:border-blue-600`}
                  placeholder="John"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input input-bordered w-full pl-10  focus:outline-none focus:border-blue-600`}
                  placeholder={"•".repeat(formData.password.length) || "••••••••"}
